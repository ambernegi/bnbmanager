          ...
          {toasts.map((t) => {
            ...
            return (
              <div
                key={t.id}
                className={[
                  "pointer-events-auto flex items-start justify-between gap-3 rounded-xl border px-3 py-2 shadow-sm",
                  "backdrop-blur supports-[backdrop-filter]:bg-white/85 dark:supports-[backdrop-filter]:bg-zinc-950/75",
